                                ...
                                <article class="clearfix">
                                    ...
                                    <div class="codo_topics_topic_content">
                                        ...
                                        <div class="codo_topics_topic_title"><a
                                                    ...
                                                    style="font-size:16px;color: @textColor;">{{{title}}}</a></div>
        ...
        <div class="col-md-4 col-12 profile-user-statistics-right">
            <div class="codo_profile profile-user-statistics-right-inner" id="">
                ...
                <div class="codo_user_details">
                    ...
                    <div style="color:#9f9f9f; font-weight:bold;"> {_t("Joined :")} <span
                                style="float:right;font-weight:bold">{$user->created|get_pretty_time}</span>
                    </div>
                    <div style="color:#9f9f9f; font-weight:bold;">
                        {_t("Last login :")} <span
                                style="float:right;font-weight:bold">{if $user->last_access eq 0}{_t('never')}{else}{$user->last_access|get_pretty_time}{/if}</span>
                    </div>
