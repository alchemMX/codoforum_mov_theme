    ...
    <div class="container" id="codo_topics_row">
        ...
        <div class="row">
            ...
            <div class="codo_categories col-lg-4" id="codo_categories_sidebar">
                ...
                <div class="row" id="codo_category_all_topics" style="border-bottom:1px solid #7c69e3;">
                ...
                <div class="codo_sidebar">

                    {if $can_search}
                        <div id="codo_sidebar_search" class="codo_sidebar_search codo_sidebar_els">
                            <input type="text" placeholder="{_t('Search')}"
                    ...
                    <div class="codo_sidebar_settings">
                        ...
                        <div style="border-bottom:1px solid #7c69e3;margin:0;height:50px;">
